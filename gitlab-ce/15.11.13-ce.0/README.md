...
docker buildx build \
  ...
  -t idoall/gitlab-ce:15.11.13-ce.0 \
  -t registry.cn-beijing.aliyuncs.com/mshk/gitlab-ce:15.11.13-ce.0 \
  --push \
  --no-cache \
  --provenance=false \
  --sbom=false .
...
idoall/gitlab-ce:15.11.13-ce.0
