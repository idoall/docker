...
docker buildx build \
  ...
  -t idoall/gitlab-ce:18.7.0-ce.0 \
  -t registry.cn-beijing.aliyuncs.com/mshk/gitlab-ce:18.7.0-ce.0 \
  --push \
  --no-cache \
  --provenance=false \
  --sbom=false .
