gitlab-runner:alpine3.15-v15.11.1
=============
...
cd gitlab-runner/alpine3.15-v15.11.1
...
docker buildx build \
  ...
  -t idoall/gitlab-runner:alpine3.15-v15.11.1 \
  --push \
  --no-cache \
  --provenance=false \
  --sbom=false .
...
docker run -d --name gitlab-runner --restart always \
    ...
    registry.cn-beijing.aliyuncs.com/mshk/gitlab-runner:alpine3.15-v15.11.1
```
