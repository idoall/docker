...
docker buildx build \
  ...
  -t idoall/docker:29-rc-dind \
  -t registry.cn-beijing.aliyuncs.com/mshk/docker:29-rc-dind \
  --push \
  --no-cache \
  --provenance=false \
  --sbom=false .
...
docker exec -it ${CONTAINERNAME} \
    ...
    --docker-image "registry.cn-beijing.aliyuncs.com/mshk/docker:29-rc-dind" \
